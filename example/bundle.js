...
var Example, Icon, React, div, h2, ref;
...
Example = React.createClass({
  ...
  render: function() {
    return div(null, div({
      className: 'example'
    }, h2(null, 'No styles'), Icon({
      name: 'icon-clock'
    })), div({
      className: 'example'
    }, h2(null, 'With className'), Icon({
      name: 'icon-clock',
      className: 'icon--colored'
    })), div({
      className: 'example'
    }, h2(null, 'With inline styles'), Icon({
      name: 'icon-clock',
      style: {
        fill: '#CCC'
      }
...
},{"../../index":3,"react":151}],2:[function(require,module,exports){
var Example, React, div;
...
},{"./Example.react":1,"react":151}],3:[function(require,module,exports){
var Icon = require('./lib/Icon.react');
module.exports = Icon;

},{"./lib/Icon.react":4}],4:[function(require,module,exports){
    ...
    render: function() {
      return React.DOM.svg({
        ...
        dangerouslySetInnerHTML: {
          __html: this._buildUseTag()
        }
      });
    },
    _buildUseTag: function() {
      return "<use xlink:href='#" + this.props.name + "' />";
    }
  });
